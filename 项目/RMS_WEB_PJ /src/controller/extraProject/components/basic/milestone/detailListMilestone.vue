<template>
  <div class="detailListMilestone" v-if="receiveData.length>0">
      ...
      <div class="body-con">
        ...
        <projectPanel
          ...
          <el-form
            ...
            label-width="120px">
            <el-row style="padding-left:60px" v-if="listItem.milestoneName.length>10">
              <el-col :span="24">
                <el-form-item
                  label="里程碑名称:"
                  prop="milestoneName"
                ...
                >
                  <span class="wrap">{{listItem.milestoneName}}</span>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row style="padding-left:73px" v-if="listItem.milestoneName.length>10">
              <el-col :span="12">
                <el-form-item
                  label="计划完成时间:"
                  prop="planFinishTime"
            ...
            <el-row style="padding-left:60px" v-if="listItem.milestoneName.length<=10">
              <el-col :span="8">
                <el-form-item
                  ...
                  :class="{'highlightStyle':getHighlightStyle(listItem,'milestoneName')}"
                >
                  <span class="milestoneName">{{listItem.milestoneName}}</span>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item
            ...
            <el-row>
              <el-col :span="24">
                ...
                >
                  <span class="wrap">{{listItem.milestoneDescription}}</span>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="24">
                <el-form-item
                  ...
                  label="是否关联任务及预期成果:"
                  prop="linkResultFlag"
                  :class="{'highlightStyle':getHighlightStyle(listItem,'linkResultFlag')}"
                >
                  <span>{{listItem.linkResultFlag==='1'?'是':'否'}}</span>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="24">
                ...
                <el-form-item
                  ...
                  :class="{'highlightStyle':getHighlightStyle(listItem,'resultInformation')}"
                >
                  <span class="wrap">{{listItem.resultInformation}}</span>
                </el-form-item>
              </el-col>
            </el-row>
          </el-form>
...
export default {
  ...
  data () {
    return {
      ...
      milestoneShowProps: ['milestoneName', 'planFinishTime', 'milestoneLeader', 'milestoneDescription', 'linkResultFlag']
    }
  },
  mounted () {
