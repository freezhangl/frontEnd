            ...
            <el-form
              ...
              <el-row>
                <el-col :span="24">
                  ...
                  <span>完成情况:&nbsp;&nbsp;</span>
                  <span>{{completionForm.completion}}</span>
          ...
          <div id="project-budget">
            <project-panel title="预算信息(单位:万元)">
              <el-form
                ...
                <el-row>
                  <el-col :span="8">
                    <el-form-item label="本次申请预算:" prop="applicationBudget" style="word-wrap:break-word">
  ...
  methods: {
    ...
    abandonFlow () {
      this.$confirm(' ', '是否确认作废?', {
        ...
        .then(() => {
          singleAPI.deletePackageTask(this.componentParams.businessSerialNumber)
            .then(res => {
              this.$message({
                type: 'success',
                center: true,
