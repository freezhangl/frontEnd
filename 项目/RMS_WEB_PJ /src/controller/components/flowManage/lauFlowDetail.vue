  ...
  <div class="launch-detail">
    ...
    <div class="main-container">
      ...
      <div class="main-content">
        ...
        <div id="task-ach">
          <!-- <achievement type="detail" :receive-data="subProjectInfoList"></achievement> -->
...
export default {
  data () {
    return {
      typeOptions: null,
      levelList: null,
      outLinePassTime: null, // 立项审批时间-TODO需要替换
      reason: null, //备注
      versionCode: '', // 项目版本号
  ...
  methods: {
    ...
    queryTemporaryInfo () {
      ...
      API.getApproveTemInfo(param)
        .then(res => {
          if (res) {
            this.outLinePassTime = this.formatDate(res.extendedAttribute.outLinePassTime)
            this.reason = res.extendedAttribute.reason
