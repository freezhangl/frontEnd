          ...
          <div class="orginal-table" @scroll="scroll">
            <table
              ...
              <tr>
                ...
                <td class="data-cell sub-bule">{{allTotal.budgetOutsourcingActualSum | formatNoData}}</td>
              </tr>
              <tr>
                ...
                <td class="data-cell sub-bule">{{allTotal.budgetInsourcingActualSum | formatNoData}}</td>
              </tr>
              <tr>
                ...
                <td class="data-cell sub-bule">{{allTotal.staffTimeActualSum | formatPersonMonth}}</td>
              </tr>
              <tr>
                ...
                <td class="data-cell sub-bule">{{allTotal.laborCostsSum | formatNoData}}</td>
                <td class="data-cell none-border sub-bule">{{allTotal.laborCostsPlanSum | formatNoData}}</td>
                <td class="data-cell sub-bule">{{allTotal.laborCostsActualSum | formatNoData}}</td>
              </tr>
              ...
              <tr>
                ...
                <td class="data-cell sub-bule">{{allTotal.travelExpensesActualSum | formatNoData}}</td>
              </tr>
              <tr>
                ...
                <td class="data-cell sub-bule">{{allTotal.conferenceExpensesActualSum | formatNoData}}</td>
              </tr>
              <tr>
                ...
                <td class="data-cell sub-bule">{{allTotal.assetDepreciationActualSum | formatNoData}}</td>
              </tr>
              <tr>
                ...
                <td class="data-cell sub-bule">{{allTotal.otherCostsActualSum | formatNoData}}</td>
              </tr>

              <tr>
                <td colspan="2" align="center" class="col-title">
                  小计
                  <el-tooltip content="小计=“合作开发费-委内”+“合作开发费-委外”+“自有人工成本”+“差旅费”+“会议费”+“资产折旧/摊销”+“其他成本”" placement="top">
                ...
                <td class="data-cell sub-bule">{{allTotal.totalAmountActualSum | formatNoData}}</td>
              </tr>
            </table>
          </div>
