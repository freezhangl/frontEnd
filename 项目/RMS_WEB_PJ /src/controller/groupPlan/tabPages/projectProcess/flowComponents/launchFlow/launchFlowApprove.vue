    ...
    <div class="main-container">
      ...
      <div class="main-content">
        ...
        <div id="project-budget" ref="projectBudget">
          <!-- 需求单位 非研发包 -->
          <DSProjectBudget v-if="projectCP !=='' && projectCP === 'ds'" :version-no="projectApprove.versionNo" :project-code="projectCode"></DSProjectBudget>
          <!-- 需求单位 研发包 -->
