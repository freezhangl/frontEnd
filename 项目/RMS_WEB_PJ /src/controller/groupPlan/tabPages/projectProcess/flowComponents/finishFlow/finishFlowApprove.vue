  ...
  <div class="finish-approve">
    ...
    <div class="main-container">
      ...
      <div class="main-content">
        <!-- 如果是接口人 - 展示查看 -->
        <div v-if="scoreBody && scoreBody.unitType === 'DEPARTMENT-ADMIN'">
          <scoreEvaluateDetail
            :data="scoreBody"
      ...
      API.queryFinishScore(param)
        .then(res => {
          if (res) {
            ...
            if (res.unitType === 'DEPARTMENT-ADMIN') {
              this.scoreBody = res
            }
          }
        })
