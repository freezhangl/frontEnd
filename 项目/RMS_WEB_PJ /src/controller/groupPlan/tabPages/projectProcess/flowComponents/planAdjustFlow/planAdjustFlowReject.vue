  ...
  <div class="change-flow-edit3">
    ...
    <div class="main-container">
      ...
      <div class="main-content">
        ...
        <div id="approved-con">
          <approval-opinion :business-opinions-array="approvalOpinionList">
          </approval-opinion>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    async saveChangeFlow (confirm = false) {
      ...
      let urlString = '?newChange=false&businessType=' + this.businessType + '&projectCode=' + this.$route.query.projectCode +
        '&developPackage=' + this.developPackage + '&projectCategory=' + this.projectCategory
      let params = {
        approveNo: this.processParams.approveNo,
