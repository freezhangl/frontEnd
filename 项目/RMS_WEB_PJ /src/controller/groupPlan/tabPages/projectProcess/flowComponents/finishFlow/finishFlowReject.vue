    ...
    <div class="main-container">
      ...
      <div class="main-content">
        ...
        <project-document-upload
          ...
          :file-list="attachmentFileList"></project-document-upload>
      ...
      flowAPI.getWorkItemDetail(parseInt(to.query.workItemID))
        .then(res => {
          if (res.currentState === 4 || res.currentState === 10) {
            ...
            next('/groupPlan/finishFlow/finishFlowDetail?' + urlString)
          }
        })
        .catch(e => {
    ...
    saveFinalInfo (confirm = false) {
      ...
      this.$refs['approveTimeForm'].validate((valid) => {
        if (valid && validType) {
          ...
          let urlString = '?newFinish=false&businessType=' + this.businessType + '&projectCode=' + this.projectCode + '&developPackage=' + this.developPackage + '&projectCategory=' + this.projectCategory
          let params = {
            approveNo: this.processParams.businessSerialNumber,
