...
`ZY.Node.Mysql` 项目是一套 集成 `express` `sequelize` `swagger-ui` 框架 api 模板，

<!-- PROJECT SHIELDS -->

[![star](https://gitee.com/Z568_568/ZY.Node.Mysql/badge/star.svg?theme=dark)](https://gitee.com/Z568_568/ZY.Node.Mysql/stargazers)
[![fork](https://gitee.com/Z568_568/ZY.Node.Mysql/badge/fork.svg?theme=dark)](https://gitee.com/Z568_568/ZY.Node.Mysql/members)

<!-- PROJECT LOGO -->
<br />

<p align="center">
  <a href="https://gitee.com/Z568_568/ZY.Node.Mysql.git">
    <img src="https://gitee.com/Z568_568/ZY.Node.Mysql/widgets/widget_3.svg" alt="Logo" width="130" height="95">
  </a>


<h3 align="center">"ZY.Node.Mysql"</h3>
  <p align="center">
...
```sh
git clone https://gitee.com/Z568_568/ZY.Node.Mysql.git
```
2. 安装依赖
