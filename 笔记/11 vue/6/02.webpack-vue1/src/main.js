...
// 在webpack 中尝试使用 Vue：
// 注意：在 webpack 中，使用import Vue from 'vue'导入的 Vue 构造函数，功能不完整，只提供了 runtime-only 的方式，
// 并没有提供 像网页中那样的使用方式；
import Vue from 'vue'
...
var vm = new Vue({
  ...
  //   login
  // }
  /* render: function (createElements) { //在webpack中如果想要通过vue，把一个组件放到页面中去展示vm实例中的render函
  数可以实现
...
// 2. 由于 在 webpack 中，推荐使用 .vue 这个组件模板文件定义组件，所以，需要安装 能解析这种文件
// 的 loader    cnpm i vue-loader vue-template-complier -D
